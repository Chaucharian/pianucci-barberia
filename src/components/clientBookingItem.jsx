...
const ClientBookingItem = (props) => {
  ...
  const { date, status, type, name, phone, isFree } = booking;
  ...
  return (
    <>
      ...
      >
        ...
        <button className={classes.crossButton} onClick={() => showModal(true)}>

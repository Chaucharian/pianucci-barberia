...
export const BookingConfirmation = (props) => {
  ...
  const dateFormated =
    typeof date === "string" ? date : format(date, "dd/MM/yyyy");
      ...
      <div className={classes.description}>
        ...
        <ul className={classes.list}>
          <li>
            ...
            <p>
              <b>Turno </b> {serviceName}
            </p>
            <p>
              <b>Ubicación </b> Pianucci Barberia - 25 de Mayo 3337 2º Oficina 2
            </p>
          </li>
        </ul>
        {showWarning() && (
          <p className={classes.warning}>
            <b>
              ¡ESPERA! Verifica que los datos sean correctos, este turno no se
              podra cancelar
            </b>
          </p>
        )}
